        ...
        return(
            <div className='main-test-wrapper'>
                ...
                <div className='answers-wrapper'>
                    <div className='answer-wrapper-4'>
                        <input type="radio" id="1" name='drone'/>
                        <label for="1"><NavLink to='../tests/test-page-41' className='link'>Верхнесалдинский городской округ</NavLink></label>
                    </div>
                    <div className='answer-wrapper-4'>
                        <input type="radio" id="2" name='drone'/>
                        <label for="2"><NavLink to='../tests/test-page-42' className='link'>Сысертский городской округ</NavLink></label>
                    </div>
                    <div className='answer-wrapper-4'>
                        <input type="radio" id="3" name='drone'/>
                        <label for="3"><NavLink to='../tests/test-page-43' className='link'>Муниципальное образование "город Екатеринбург"</NavLink></label>
                    </div>
                </div>
